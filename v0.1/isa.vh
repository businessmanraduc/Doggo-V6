...
// live here so that the RTL never contains raw numeric literals.
// =============================================================================
...
`define INSTR_WFI     32'h1050_0073   // Wait For Interrupt (treat as NOP in Phase 1)
`define INSTR_FENCEI  32'h0000_100F   // FENCE.I (treat as NOP in Phase 1)
...
`define CF3_C_JAL       3'b001   // RV32C only (becomes C.ADDIW in RV64C)
