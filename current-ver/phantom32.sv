...
module cpu (
  ...
  // ── Instruction memory ─────────────────────────────────────────────────────
  output logic [31:0] imem_addr_a,     // fetch address: PC
  output logic [31:0] imem_addr_b,     // fetch address: PC + 2
  ...
  // ===========================================================================
    ...
    logic [4:0]  if_id_rs1;         // rs1 index (from fast_decoder)
    logic [4:0]  if_id_rs2;         // rs2 index (from fast_decoder)
    logic [4:0]  if_id_rd;          // rd  index (from fast_decoder, for hazard unit)
  ...
  // ===========================================================================
    ...
    logic [31:0] pc_inc_base  = if_isCompressed ? 32'd2 : 32'd4;
    logic [31:0] pc_inc_base2 = if_isCompressed ? 32'd4 : 32'd6;
    logic [31:0] pc_inc_seq   = r_pc + pc_inc_base;
    logic [31:0] pc_inc_seq2  = r_pc + pc_inc_base2;

    // Pre-calculating +2 versions for dual-issue fetch
    logic [31:0] csr_mtvec2   = csr_mtvec     + 32'd2;
    logic [31:0] csr_mepc2    = csr_mepc      + 32'd2;
    logic [31:0] ex_target2   = ex_targetAddr + 32'd2;
    logic [31:0] r_pc_2       = r_pc          + 32'd2;
